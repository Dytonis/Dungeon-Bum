...
namespace Assets.Scripts.Actor
{
    public class ActorController : MonoBehaviour
    {
        ...
        public Float2 Velocity = Float2.zero; //matrices allow for editing of individual components without declaring new objects
        ...
        private Float2 newPosition = Float2.zero;
        ...
        void Start()
        {
            ...
            newPosition = new Float2(transform.position.x, transform.position.y);
        }
        ...
        {
            Float2 bottomLeftNewPosition = new Float2(newPosition.x - (collider.Size.x / 2), newPosition.y - (collider.Size.y / 2));
            Float2 bottomRightNewPosition = new Float2(newPosition.x + (collider.Size.x / 2), newPosition.y - (collider.Size.y / 2));
            Float2 topLeftNewPosition = new Float2(newPosition.x - (collider.Size.x / 2), newPosition.y + (collider.Size.y / 2));
            Float2 topRightNewPosition = new Float2(newPosition.x + (collider.Size.x / 2), newPosition.y + (collider.Size.y / 2));
